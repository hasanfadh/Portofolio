...
function App() {
  ...
  return (
    <div className="bg-[#020410] min-h-screen relative" style={{ fontFamily: "'Inter', 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif" }}>
      ...
      <div className="relative z-10 px-4 sm:px-6">
        <header className="text-center mb-8 sm:mb-12">
          <SplitText
            ...
            className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white block mb-2"
            strokeColor='#000000'
            delay={50}
            duration={0.8}
            splitType="chars"
          ...
          <div className="text-white mt-4 flex flex-col items-center justify-center gap-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
              {projects.map((project) => {
                ...
                return (
                  ...
                  >
                    <div className={`absolute -inset-1 bg-gradient-to-r ${project.gradient} rounded-3xl blur-2xl transition-all duration-700 ${hoveredProject === project.id ? 'opacity-100 scale-105' : 'opacity-0'}`}></div>
                    ...
                    <div className={`relative bg-slate-950/90 backdrop-blur-xl border ${hoveredProject === project.id ? colors.border : 'border-slate-800/50'} rounded-2xl overflow-hidden transition-all duration-500 ${hoveredProject === project.id ? `shadow-2xl ${colors.shadow}` : ''}`}>
                      ...
                      <div className="p-5 sm:p-6 md:p-8">
                        ...
                        <a 
                          ...
                          className={`group/btn inline-flex items-center gap-2 sm:gap-3 px-5 sm:px-6 md:px-8 py-2.5 sm:py-3 md:py-4 bg-gradient-to-r ${project.gradient} border ${colors.border} text-white font-bold rounded-xl transition-all duration-300 hover:shadow-xl ${colors.shadow} hover:-translate-y-1 text-xs sm:text-sm md:text-base`}
                        >
          ...
          <section className="mb-16 sm:mb-24 md:mb-32">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 md:gap-10">
              ...
              <div className="group/card relative">
                <div className="absolute -inset-1 bg-gradient-to-r from-blue-500/20 to-purple-600/20 rounded-3xl blur-2xl opacity-0 group-hover/card:opacity-100 transition-opacity duration-700"></div>
                <div className="relative bg-slate-950/80 backdrop-blur-xl border border-slate-800/50 rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-10 lg:p-12 hover:border-blue-500/50 transition-all duration-500">
                  ...
                  <div className="flex items-center gap-3 sm:gap-4 mb-6 sm:mb-8 md:mb-10">
                    <div className="relative">
                      <div className="absolute inset-0 bg-gradient-to-br from-blue-500 to-purple-600 rounded-xl sm:rounded-2xl blur-lg opacity-50"></div>
                      <div className="relative w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-gradient-to-br from-blue-500 to-purple-600 rounded-xl sm:rounded-2xl flex items-center justify-center">
                  ...
                  <div className="flex flex-wrap gap-2 sm:gap-3 md:gap-4">
                    {hardSkills.map((skill) => (
                      ...
                      >
                        <div className={`absolute inset-0 bg-gradient-to-r from-blue-500/20 to-purple-600/20 rounded-xl sm:rounded-2xl blur-xl transition-opacity duration-300 ${hoveredSkill === skill ? 'opacity-100' : 'opacity-0'}`}></div>
                        <div className="relative px-3 sm:px-4 md:px-5 lg:px-6 py-2 sm:py-2.5 md:py-3 lg:py-3.5 bg-gradient-to-br from-slate-800/80 to-slate-900/80 border border-slate-700/50 text-slate-300 rounded-xl sm:rounded-2xl text-xs sm:text-sm font-semibold hover:border-blue-500/50 hover:text-white transition-all duration-300 cursor-pointer">
                          {skill}
                        </div>
                      </div>
                    ))}
              ...
              {/* Soft Skills */}
              <div className="group/card relative">
                <div className="absolute -inset-1 bg-gradient-to-r from-purple-500/20 to-pink-600/20 rounded-3xl blur-2xl opacity-0 group-hover/card:opacity-100 transition-opacity duration-700"></div>
                <div className="relative bg-slate-950/80 backdrop-blur-xl border border-slate-800/50 rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-10 lg:p-12 hover:border-purple-500/50 transition-all duration-500">
                  ...
                  <div className="flex items-center gap-3 sm:gap-4 mb-6 sm:mb-8 md:mb-10">
                    <div className="relative">
                      <div className="absolute inset-0 bg-gradient-to-br from-purple-500 to-pink-600 rounded-xl sm:rounded-2xl blur-lg opacity-50"></div>
                      <div className="relative w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-gradient-to-br from-purple-500 to-pink-600 rounded-xl sm:rounded-2xl flex items-center justify-center">
                        <svg className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="flex flex-wrap gap-2 sm:gap-3 md:gap-4">
                    {softSkills.map((skill) => (
                      <div
                        ...
                        onMouseLeave={() => setHoveredSkill(null)}
                      >
                        <div className={`absolute inset-0 bg-gradient-to-r from-purple-500/20 to-pink-600/20 rounded-xl sm:rounded-2xl blur-xl transition-opacity duration-300 ${hoveredSkill === skill ? 'opacity-100' : 'opacity-0'}`}></div>
          ...
          <section className="mb-12 sm:mb-16 md:mb-20">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
              {certifications.map((cert) => (
                ...
                >
                  <div className={`absolute -inset-1 bg-gradient-to-r from-emerald-500/30 to-teal-500/30 rounded-2xl blur-2xl transition-all duration-700 ${hoveredCert === cert.id ? 'opacity-100' : 'opacity-0'}`}></div>
                  ...
                  <div className="relative bg-slate-950/90 backdrop-blur-xl border border-slate-800/50 rounded-xl sm:rounded-2xl p-6 sm:p-8 md:p-10 hover:border-emerald-500/50 transition-all duration-500 h-full flex flex-col">
                    ...
                    <div className="relative mb-6 sm:mb-8">
                      <div className="absolute inset-0 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-xl sm:rounded-2xl blur-lg opacity-30"></div>
                      <div className="relative w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-xl sm:rounded-2xl flex items-center justify-center">
      ...
      {/* Logo Loop */}
      <div className="h-20 sm:h-24 md:h-28 w-full relative overflow-hidden mb-8">
        <LogoLoop
          logos={techLogos}
          speed={120}
          direction="left"
